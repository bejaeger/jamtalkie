...
MockAudioServiceService getAndRegisterAudioServiceService() {
  _removeRegistrationIfExists<AudioServiceService>();
  final service = MockAudioServiceService();
  locator.registerSingleton<AudioServiceService>(service);
  return service;
}
